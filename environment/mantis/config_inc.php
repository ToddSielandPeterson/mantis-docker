...
$g_anonymous_account            = getenv('CRYPTO_SALT');

# --- Email Configuration ---
$g_phpMailer_method             = PHPMAILER_METHOD_MAIL; # or PHPMAILER_METHOD_SMTP, PHPMAILER_METHOD_SENDMAIL
$g_smtp_host = getenv('SMTP_HOST');
$g_smtp_username = getenv('SMTP_USER');
$g_smtp_password = getenv('SMPT_PASSWORD');
$g_webmaster_email      = getenv('EMAIL_WEBMASTER_ADDRESS');
$g_from_email           = getenv('EMAIL_SENDER_ADDRESS');        # the "From: " field in emails
$g_return_path_email    = getenv('EMAIL_RETURN_ADDRESS');  # the return address for bounced mail
